# Shared Haldane-model definitions: honeycomb geometry, fermionic operators, the MPO
# Hamiltonian and the charge-shift helper. One definition for
# the benchmark scripts and the probes.
...
export HaldaneMPO, shift_my_charge
